    ...
    ? [
        {
          ...
          current: `${data.fulfillmentRate.toFixed(1)}%`,
          target: "> 95.0%",
          status: data.fulfillmentRate >= 95 ? "EXCELLENT" : data.fulfillmentRate >= 85 ? "HEALTHY" : "NEEDS_ATTENTION",
        ...
        },
        {
          ...
          current: `${data.returnRate.toFixed(1)}%`,
          target: "< 3.0%",
          status: data.returnRate <= 3.0 ? "HEALTHY" : "NEEDS_ATTENTION",
        ...
        },
        {
          ...
          current: data.averageRating > 0 ? `${data.averageRating.toFixed(1)} / 5.0` : "No ratings yet",
          target: "> 4.50",
          status: data.averageRating >= 4.5 ? "EXCELLENT" : data.averageRating > 0 ? "HEALTHY" : "HEALTHY",
