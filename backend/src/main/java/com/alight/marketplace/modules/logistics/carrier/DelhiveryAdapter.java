...
@Component
public class DelhiveryAdapter implements ShippingCarrierAdapter {

    public static final String CARRIER_CODE = "DELHIVERY";
    ...
    public ShippingRateDto calculateRate(RateCalculationRequest request) {
        ...
        BigDecimal baseRate = isExpress ? new BigDecimal("95.00") : new BigDecimal("50.00");
        BigDecimal incrementalRate = isExpress ? new BigDecimal("50.00") : new BigDecimal("30.00");
        ...
        BigDecimal insurance = new BigDecimal("8.00");
